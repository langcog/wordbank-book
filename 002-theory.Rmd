...
The ability to use language in its lexical and combinatorial richness -- with hundreds of thousands of words, and an infinity of possible meanings -- is uniquely human. In The study of language acquisition has been a traditional locus of our search to understand the nature of this ability. As such, the nature of the abilities that allow human children to acquire a language is one of the historical "great debates," in which different proposals about the architecture of the human mind and the nature of human uniqueness have been proposed. Does language arise from domain-specific adaptations for syntactic structure [@chomsky1981;@chomsky2014]? Or does it arise from a combination of environmental input and sophisticated, general-purpose learning mechanisms [@elman1996]? Two poles have traditionally emerged in this discussion (Figure \@ref(fig:poles) ): from domain-general empiricist proposals to domain-specific, nativist proposals. 

In this chapter, we begin by presenting the perspective from these poles but argue that they are rarely helpful in the practice of understanding the scope and course of early language learning. Instead, we argue for the development of theories that describe the scope and course of language learning as a whole, as well as its quantative variation across children, langugaes, and cultures. These concerns lead us to develop a theoretical vocabulary that focuses on consistency and variability; connections across timescales of learning' and the notion of process, rather than content, universals. We end by discussing the role of replication and larger datasets in building quantitative theories. 
