...
```{r methods-admins, fig.cap="Log-scaled number administrations for each instrument."}
...
```{r methods-russian-animals, fig.cap="Mean proportion children reported to produce each item in the sounds category for Russian Words and Sentences."}
...
ggplot(ords, aes(x = language, y = estimate, col = form)) + 
