...
a <- ggplot(coefs_4pl, 
  ...
  scale_color_ptol(name = "Lexical Class") + 
  xlab("Discrimination") + 
  ylab("Difficulty")
...
b <- ggplot(coefs_4pl, 
  ...
  geom_histogram() + 
  scale_fill_ptol(name = "Lexical Class") + 
  xlab("Discrimination") +
  ylab("Number of Words") +
  xlim(0,4)
