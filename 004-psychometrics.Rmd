...
```{r psycho-lexcat-summary, fig.cap="Mean discrimination values for individual words' in production and comprehension measures from the Words and Gestures form (error bars show SD)."}
