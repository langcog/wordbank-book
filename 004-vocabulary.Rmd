...
In sum, although there are certainly some reporting biases represented in the data, these results do not appear likely to be an artifact of reporting bias. [MORE HERE?]
...
In sum, we observed a striking consistency in the individual variability of children's vocabulary during their second year. Across languages and forms, it appears to be the norm that toddlers vary. These results echo the conclusions of @bornstein2005 based their comparative data across Spanish, English, and Italian, who noted that “individual variability is probably a universal feature of early language acquisition” (p. 311). 
