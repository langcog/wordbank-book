...
demo_int_plot <- function(demo_str, form, measure) {
  ...
  ggplot(aes(x = beta, y = language)) +
    ...
    labs(x = glue::glue("Interaction between age and {tolower(demo_label(demo_str))}"), y = "")
}
```
...
We next turn to production data on the Words & Sentences instrument, which we expect to be much more informative regarding production (see Figure \@ref(fig:demo-data-plot-sex-ws-prod). Visual inspection confirms differences in almost every case, and an analysis of the fitted models (see Figure \@ref(fig:demo-int-sex-ws-prod)) shows that `r nrow(filter(analyses$WS.production$sex$model_summary, p < .05, beta > 0))` of `r nrow(analyses$WS.production$sex$model_summary)` languages show a statistically significant female advantage!
...
We perform the same set of analyses as for sex, shown in Figure \@ref(fig:demo-data-plot-birth-order-wg-comp), Figure \@ref(fig:demo-mmad-age-plot-birth-order-wg-comp), Figure \@ref(fig:demo-mmad-plot-birth-order-wg-comp), and Figure \@ref(fig:demo-int-birth-order-wg-comp).
...
The parallel set of analyses for WS Production data are shown in Figure \@ref(fig:demo-data-plot-birth-order-ws-prod), Figure \@ref(fig:demo-mmad-age-plot-birth-order-ws-prod), Figure \@ref(fig:demo-mmad-plot-birth-order-ws-prod), and Figure \@ref(fig:demo-int-birth-order-ws-prod).
...
We again perform the same set of analyses, shown in Figure \@ref(fig:demo-data-plot-mom-ed-wg-comp), Figure \@ref(fig:demo-mmad-age-plot-mom-ed-wg-comp), Figure \@ref(fig:demo-mmad-plot-mom-ed-wg-comp), and Figure \@ref(fig:demo-int-mom-ed-wg-comp).
...
The next analyses are shown in Figure \@ref(fig:demo-data-plot-mom-ed-ws-prod), Figure \@ref(fig:demo-mmad-age-plot-mom-ed-ws-prod), Figure \@ref(fig:demo-mmad-plot-mom-ed-ws-prod), and Figure \@ref(fig:demo-int-mom-ed-ws-prod).
