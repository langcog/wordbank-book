...
```{r growths, fig.width = 10, fig.height = 6}
binary_data %>%
...
```{r sex_type_plot, fig.width = 8, fig.height = 6}
...
```{r ses_type_plot, fig.width = 8, fig.height = 6}
