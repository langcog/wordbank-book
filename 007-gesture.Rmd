...
For comparison, we collapse the "sometimes" and "often" into a single value, and plot the proportion of children at each age whose parents report that they produce each gesture (Figure \@ref(fig:gesture-first-gesture-binary-figure)). The trajectories look generally smooth and prima facie reasonable, with the potential exception of the _smacklip_ gesture for which there is very little developmental change (this gesture, which corresponds to the vocalization _yum yum_, may be unusual or less stereotyped).
