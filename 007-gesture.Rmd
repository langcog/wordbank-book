...
```{r gesture-first-gesture-figure, fig.width = 8.5, fig.height = 6}
ggplot(first_gestures_ordered, aes(x = age, y = n, color = value, label = value)) + 
  ...
  directlabels::geom_dl(method = list(directlabels::dl.trans(x=x +.2),
                                      "last.qp", cex=1)) +
  scale_x_continuous(name = "age (months)", limits = c(7.5, 25),
                    breaks = seq(8, 18)) +
  scale_y_continuous(name = "Prop. Responses") +
  theme(legend.position = "none") 
```

For comparision, we collapse the "sometimes" and "often" into a single value, and plot the proportion of children at each age whose parents report that they produce each gesture. The trajectories look generally smooth and prima facie reasonable, with the potential exception of the "smacklip" gesture for which there is very litte developmental change (this gesture, which corresponds to the vocalization "yum yum," may be unusual or less stereotyped).
...
```{r gesture-first_gesture_binary_figure, fig.width = 6, fig.height = 4}
ggplot(first_gestures_binary_ordered, aes(x = age, y = n, color = definition, 
  ...
  scale_x_continuous(name = "age (months)", limits = c(5.5, 18.5),
                    breaks = seq(8, 18)) + 
  scale_y_continuous(name = "Prop. producing") +
  theme(legend.position = "none")
```
...
```{r gesture-other-figure, fig.width = 8, fig.height = 8}
ggplot(other_gestures_ordered, aes(x = age, y = n, color = definition, 
  ...
  directlabels::geom_dl(method = list(directlabels::dl.trans(x=x -.2),
                                      "first.qp", cex=1)) +
  #scale_color_brewer(palette = "Set1") + 
  scale_x_continuous(name = "age (months)", limits = c(4.5, 18.5),
                    breaks = seq(8, 18)) + 
  scale_y_continuous(name = "Prop. producing") +
  theme(legend.position = "none") 
...
```{r gesture_aoa, fig.width = 6, fig.height = 4}
