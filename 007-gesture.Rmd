...
```{r gesture-first_gesture_figure, fig.cap="Proportion of children who produce each of the first gestures \"often\", \"sometimes\", and \"not yet\" over development."}
...
```{r gesture-other-figure, fig.width = 10, fig.height = 5, fig.cap="Production of first gestures by American-English learning children over development"}
...
```{r gesture-growths, fig.width = 10, fig.height = 6, eval = F, include = F}
