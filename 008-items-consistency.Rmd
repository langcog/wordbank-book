...
Figure \@ref(fig:items-plot-cors) shows the broader pattern of cross-linguistic correlations across successively-larger subsets of the vocabulary, as compared to a random baseline. Especially in the domain of production, we see a level of consistency that substantially exceeds baseline.
