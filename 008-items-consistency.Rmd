...
the similarity of compared the crosslinguistic correlations in ages of acquisition with an external measure of language similarity.
`
...
cor.test(lev_cors$correlation, lev_cors$ipa, use = "pairwise")

```


These data suggest despite the high degree of cross-linguistic similarities in the order of acquisition of words--both in comprehension and production--the differences we do find likely reflect reflect differences in the target languages being learned.
