# Demographic Variation in Individual Words^[An earlier version of the gender analyses below was presented to the Boston University Conference on Language Development in 2016] {#item_demographics}
...
fit_demo_model <- function(language, measure, demo, demo_data) {
  ...
  safe_model <- possibly(function() {
    ...
    save(model, file = glue("data/items_demo/models/{language}_{measure}_{demo}.Rds"))
    return(model)
  }, otherwise = NULL)
  safe_model()
...
demo_groups %>%
  ...
  cluster_assign_value("fit_demo_model", fit_demo_model) %>%
  cluster_assign_value("contr_back_diff", contr_back_diff)
