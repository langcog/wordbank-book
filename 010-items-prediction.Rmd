...
We use data from the items on WG forms for our comprehension measure, and data from the items in common between WG and WS forms for our production measure. Placeholder items, such as "child's own name," are excluded. Table \@ref(tab:aoapred-lang-stats-table) gives an overview of our acquisition data. Each of the datasets was collected in contexts in which the particular language was the language of the community, e.g., the Mexican Spanish CDI data were collected in several areas of Mexico; longitudinal administrations were excluded.
