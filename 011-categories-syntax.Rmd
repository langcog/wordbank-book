# Vocabulary Composition: Syntactic^[An earlier version of this work was reported to the Boston University Conference on Language Development in 2015 by Braginsky, Marchman, Yurovsky, & Frank.] {#categories}
...
```{r 4_plot_area_demo, fig.asp=0.5}
...
```{r 4_plot_points_wg_comp, fig.asp=1.25}
...
```{r 4_plot_points_ws, fig.asp=1.25}
...
```{r mandarinFormComparisonMunging}
