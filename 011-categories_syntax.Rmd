...
write_feather(vocab_comp_data, "data/categories_syntax/vocab_comp_data.feather")
```
...
write_feather(areas,"data/categories_syntax/vocab_comp_areas.feather")
```


```{r catsyn-areas_read}
areas <- read_feather("data/categories_syntax/vocab_comp_areas.feather")
```
...
* Every language showed a substantial bias against function words, supporting the generalization that these are acquired much later than content words, despite their typically higher frequency (see \@ref(aoa-pred)). This bias was larger on average than biases in type of content words. 
