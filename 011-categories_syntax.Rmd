...
* Every language showed a substantial bias against function words, supporting the generalization that these are acquired much later than content words, despite their typically higher frequency (see \@ref(aoapred)). This bias was larger on average than biases in type of content words. 
