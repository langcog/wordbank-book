...
As in other analyses (see Chapter \@ref(vocabulary)), Mandarin WS has the highest level of production. American and Australian English also tend to have high levels of color production. Interestingly, Kiswahili has by far the lowest level of color production, perhaps related to the availability of manufactured toys of contrastive colors [@bornstein1985]. 
