...
```{r gram_prep_data, child="_grammar_lex.Rmd", eval=FALSE}
```
...
```{r gram_grammar_plot_complexity}
...
```{r gram_age_plot_wordforms}
grammar_age_plot("Word Forms")
```


```{r gram_age_plot_complexity}
