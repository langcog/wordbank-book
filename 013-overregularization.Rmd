...
__English nouns__
```{r ovreg_plt_traj_eng_nouns, dependson="ovreg_byitem", fig.height=5}
plt_item_traj("English (American)", "nouns")
```

__English verbs__
```{r ovreg_plt_traj_eng_verbs, dependson="ovreg_byitem", fig.height=11}
plt_item_traj("English (American)", "verbs")
```

__Norwegian nouns__
```{r ovreg_plt_traj_nor_nouns, dependson="ovreg_byitem", fig.height=5}
plt_item_traj("Norwegian", "nouns")
```

__Norwegian verbs__
```{r ovreg_plt_traj_nor_verbs, dependson="ovreg_byitem", fig.height=11}
...
__Nouns__
```{r ovreg_plt_props_nouns, dependson="ovreg_plt_props", fig.height=5.5}
plot_type_props("nouns")
```

__Verbs__
```{r ovreg_plt_props_verbs, dependson="ovreg_plt_props", fig.height=11}
...
```{r ovreg_plt_bins_eng, fig.height=6}
...
```{r ovreg_plt_dense_emp, dependson="ovreg_joined", fig.height=6}
...
```{r ovreg_plt_switch_emp, dependson="ovreg_joined", fig.height=6}
...
```{r ovreg_plt_switch_fit, dependson="ovreg_joined", fig.height=6}
