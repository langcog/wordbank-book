...
* Variation between individuals appears extremely stable from a longitudinal perspective. 
...
```{r style_long_data_norwegian_ecdf}
ggplot(filter(n_long_ws, n_admins > 10, 
              language == "Norwegian"), 
...
```{r style_pairwise_long_cors_raw}
long_cors <- n_long_ws %>%
  unite("id", c("original_id", "source_name")) %>%
