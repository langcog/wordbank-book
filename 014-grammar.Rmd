...
```{r gram-item-effects-plot, fig.cap="Age effect estimate for each grammar item in each language (ranges indicate 95% confidence intervals).", fig.height=9, fig.width=8}
