...
In summary, our data suggests that when aggregated across children, overregularization doesn't appear to have a set relationship with age, and does relate to vocabulary size, though not as strongly as does correct morphology. Additionally, overregularization is highly variable across children, but relatively stable within children across nouns and verbs.


## Longitudinal data

Next, we ask how individual children's overregularization trajectories can paint a clearer picture of the overall developmental time course of overregularization.
...
This chapter examined overregularization data from the morphology items of the Words and Sentences form. A central takeaway from our analyses is that there is tremendous heterogeneity in these data -- some children are never reported to overgeneralize within the age range of the sample, while others do substantially more, without a set developmental time course across children. We got a handle on this variability by observing that children with larger vocabularies tend to overregularize more and than children who overregularize more nouns tend to overregularize more verbs. Furthermore, individual children's trajectories can be fruitfully categorized by overall shape, leading to the observation that for children who overregularize, approximately half begin recovery towards correct inflection at around 30 months and half continue to overregularize more and more through 36 months; and that overregularization tend to proceed in tandem for nouns and verbs.
