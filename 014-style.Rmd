...
**notes on new intro**
in general, analyses from before can be individual differences?

- rate diffeences
- syntactic category composition differences
- vocabulary in particular (idiosyncrasy)
...
QUANTIFY THIS VARIABILITY ACROSS LANGUAGES A LA 4.
