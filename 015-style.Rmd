...
* Finally, recalling the conclusions of Chapter \@ref(psychometrics), variations in rate -- though perhaps least interesting from a Batesian perspective -- nevertheless are the most detectable first order signal in our data. 
