...
```{r style-sibs-vocab-comp, fig.cap="Proportion nouns in vocabulary by age, with color showing birth order."}
...
```{r style-sibs-vocab-comp-resid, fig.cap="Vocabulary-residualized noun proportion by age, with color showing birth order."}
...
```{r style-productivity-coefs, fig.cap="Effect of age on productivity ratio in each language (ranges indicates 95 percent confidence intervals)."}
