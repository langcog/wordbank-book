...
@lieven1992 was interested in the possibility that an alternative route into language from a referential style would be the use of construction-based generalizations. To test this hypothesis using our bias-corrected measure, we examine correlations with grammatical ability.
...
@nelson1973 noted that younger siblings had more expressive vocabulary. This observation is consistent with the confounding of vocabulary size and composition, since younger siblings tend to have smaller vocabularies (see Chapter \@ref(demographics)). But there are other reasons to suspect that vocabulary composition could differ for siblings. @tomasello1985 observe that older siblings tend to be more directive with their younger sibs. Since more directive speech has been argued to lead to an "expressive" style, perhaps younger sibs have a different vocabulary composition due to the input they receive [@tomasello1983].^[Technically, the observation that directive speech leads to expressive style could also be due to confounding of amount of speech; more directive parents also tend to be those who talk to children less [e.g., @hart1995].] 
...
```
Further, when we examine the trend in the residualized noun proportion, it appears even weaker and is observed in fewer languages. This pattern is shown in Figure \@ref(fig:style-sibs-vocab-comp-resid). Thus, we conclude that differences in vocabulary composition across birth order are likely small and may be at least in part due to faster learning by earlier-born siblings. 
