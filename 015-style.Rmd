...
@nelson1973 noted that younger siblings had larger expressive vocabularies. This observation is consistent with the confounding of vocabulary size and composition, since younger siblings tend to have smaller vocabularies (see Chapter \@ref(demographics)). But, there are other reasons to suspect that vocabulary composition could differ for children who are younger vs. older siblings. @tomasello1985 observe that older siblings tend to be more directive with their younger siblings. Since more directive speech has been argued to lead to an "expressive" style, perhaps younger siblings have a different vocabulary composition due to the input they receive [@tomasello1983].^[Technically, the observation that directive speech leads to expressive style could also be due to confounding of amount of speech; more directive parents also tend to be those who talk to children less [e.g., @hart1995].] 
...
Figure \@ref(fig:style-rateplot) shows children's estimated growth rates in the measurement period leading up to that month (number of words learned since the last longitudinal measurement divided by number of months since that measurement) plotted by total words produced in that month. There is a clear quadratic shape to this pattern, almost certainly caused by ceiling effects for children who are "running out of words" on the form.
