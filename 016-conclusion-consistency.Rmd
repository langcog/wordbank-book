...
This strategy executes the general idea discussed in Chapter \@ref(intro-theory): We have identified "signatures" of language development, measurements that we believe are theoretically interesting or central. We have then quantified variability in these signatures across languages. These estimates of cross-linguistic variability are measurements of the degree to which aspects of language development are more or less similar across different languages and cultural contexts. We discuss the types of inferences licensed -- and not licensed -- by these analyses below. 
...
sigs <- str_replace(sigs, "gesture/vocab","Gesture/Vocab")
sigs <- str_replace(sigs, "Word forms/vocab","Morphology/Vocab")
sigs <- str_replace(sigs, "Complexity/vocab","Grammar/Vocab")
...
# sigs <- str_replace(sigs, "Bias for Logic", "Bias Against Logic")
# sigs <- str_replace(sigs, "Bias for Color", "Bias Against Logic")
