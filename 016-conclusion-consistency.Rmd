...
What is the picture of language development that emerges from the analysis above? In this section we return to the theoretical speculation of Chapter \@ref(intro-theory). The goal of characterizing areas of consistency in theoretically-relevant signatures of early language was to be able to provide constraints on theory. We turn back to the question of these constraints. First, we consider generalizations from our data. In the next section, we turn to the possible processes that could support these generalizations and hence their relation to other theories of acquisition. 

First, we consider three major generalizations from our data. These are, roughly speaking, that:

1. The language system is tightly woven or perhaps even unitary. Although our data provide multiple opportunities for aspects of language development (communication, vocabulary, morphology, grammar) to pull apart across individuals, they instad hang together very tightly across every language examined. 

2. The content of children's early language is strikingly similar across languages, both in the specific words they learn and the general categories that are over-represented in their vocabularies. These foci likely emerge from a combination of children's particular attention and interests; the communicative priorities of child-caregiver dyads; and the informational structure of language, which renders certain aspects of langauge easier to learn than others. 
...
Unitary construct
hangs together, even when it's not CDI
modular subsystems? 
look at grammar lex t1 - t2 in norwegian/english
Dixon/marchman linear-nonlinear
  - our idea is not that the shape of lex-grammar is of a particular sort, it's that the shape is consistent. 
