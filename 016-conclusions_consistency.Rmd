...
2. Predictors of word difficulty, from Chapter \@ref(aoapred). The consistency of different regression predictors of age of acquisition are here represented by their cross-linguistic consistency, for comparison with other measures. The units over which  CV is computed are standardized regression coefficients. 
