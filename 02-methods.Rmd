...
In Wordbank, we define a *standardized month* as 365.2524 / 12 = `r 365.2524 / 12` days. When possible, we compute the number of days from birth to testing and then compute the number of standardized months that the child has lived. 
...
### Cross-linguistic and cross-instrument architecture
...
This section gives a broad overview of the data we have available. Specifics of each sample are given in Appendix \@ref(appendix-data)
