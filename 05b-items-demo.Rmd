...
fit_demo_madm <- function(lang_data, demo) {
  ...
  demo_lang_data <- lang_data %>%
    ...
    mutate(birth_order = birth_order %>%
             fct_recode("Third+" = "Third",
                        ...
                        "Third+" = "Eighth"),
           mom_ed = mom_ed %>%
             fct_recode("None / Primary" = "None",
                        "None / Primary" = "Primary",
                        "Some Secondary / Secondary" = "Some Secondary",
                        "Some Secondary / Secondary" = "Secondary",
                        "Some College / College" = "Some College",
                        "Some College / College" = "College",
                        "Some Graduate / Graduate" = "Some Graduate",
                        "Some Graduate / Graduate" = "Graduate"))
  ...
  fit_group <- function(group_data) {
    ...
    group_data %>%
      ...
      select(unscaled_age, age, uni_lemma, definition, fitted) %>%
      distinct()
  }
