# Estimating Total Vocabulary {#appendix-vocabulary}
...
write_feather(by_item, "data/appendix-vocabulary/by_item.feather")
```

```{r vocabest-item_load}
by_item <- read_feather("data/appendix-vocabulary/by_item.feather")
```
