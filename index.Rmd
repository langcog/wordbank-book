...
In this book, we examine the question of variability and consistency in early language through the lens of the CDI. This book is a product of the Wordbank project [@frank2016], a project deovted to archiving CDI data in a structured format so that it can be explored and analyzed in the service of describing vocabulary acquisition. The database currently contains data from more than `r length(admins$data_id)` CDI form administrations across `length(unique(instruments$language))` languages. Wordbank is also continuously growing as new researchers contribute data. We believe this database is the largest and most diverse set of data on early language acquisition currently in existence.
