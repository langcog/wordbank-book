...
<!-- var fig_span = document.getElementById("fig:preface-outline"); -->
<!-- var fig_img = fig_span.nextElementSibling; -->
<!-- var fig_p = fig_img.nextElementSibling; -->
<!-- fig_p.innerHTML = fig_p.innerHTML.replace("Figure 0.", "Figure P."); -->

<!-- var fig_ref = $( "a:contains('0.1')" ); -->
<!-- console.log(fig_ref.innerHTML); -->
<!-- fig_ref.innerHTML.replace("0.1", "P.1"); -->
