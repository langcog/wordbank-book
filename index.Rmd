...
You can read as a narrative monograph. If you do so, we recommend you look at Practical Foundations and Methods before moving on to substantive chapters of interest. We also recommend you read our theoretical synthesis in the Conclusions chapter. 

You can read as a reference book. If you take this approach, just dive into any chapter that is of interest, knowing that you may need to use some of the terminology defined in the Methods chapter to interpret the constructs and analysess that are used. 
