...
The book ends with three synthetic chapters. Chapter \@ref(conclusion-consistency) synthesizes observations across languages for the preceding chapters to quantify variability and consistency directly across phenomena. Chapter \@ref(conclusion-scale), considers broadly the question of what the process of language acquisition looks like from the birds-eye view afforded by our data. And Chapter \@ref(conclusion-beyond-cdi) considers methodological morals from our work here and the outlook on measuring children's early language beyond the CDI.
