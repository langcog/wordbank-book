...
The book ends with two synthesis chapters. Chapter \@ref(conclusion-consistency) synthesizes observations across languages for the preceding chapters to quantify variability and consistency directly across phenomena. And the concluding chapter, Chapter \@ref(conclusion-scale), considers broadly the question of what the process of language acquisition looks like from the birdseye view afforded by our data. 
